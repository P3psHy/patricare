...
export default function Dashboard() {
  return (
    <main className="w-full flex-1 p-8 space-y-8">
      <header>
        <h1 className="text-3xl font-semibold text-gray-900">Tableau de bord</h1>
        <p className="text-gray-600">Bienvenue dans votre espace de gestion immobilière.</p>
      </header>
          ...
          return (
            ...
            >
              <div className="flex justify-between">
                <div className={`w-12 h-12 rounded-lg ${statColorClasses[stat.color]} flex items-center justify-center`}>
      ...
      <section className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <article className="lg:col-span-2 rounded-xl border border-gray-200 bg-white shadow-sm">
          <header className="flex items-center justify-between border-b border-gray-200 p-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Mes biens récents</h2>
              <p className="text-sm text-gray-500">Suivez vos derniers mouvements immobiliers.</p>
            </div>
            <Link href="/mesBiens" className="text-sm font-medium text-blue-600 hover:text-blue-700">
              Voir tout
            </Link>
          </header>
              ...
              <tbody>
                {recentProperties.map((property) => (
                  <tr key={property.id} className="border-t border-gray-100 text-sm text-gray-700 hover:bg-gray-50">
                    ...
                    <td className="p-4 font-semibold text-gray-900">{property.rent}</td>
                    <td className="p-4">
                      <span
        ...
        <article className="rounded-xl border border-gray-200 bg-white shadow-sm">
          <header className="flex items-center justify-between border-b border-gray-200 p-6">
            <div>
              ...
              <p className="text-sm text-gray-500">Restez à jour sur les échéances clés.</p>
            </div>
          ...
          <div className="p-6">
            ...
            <Link
              href="/documents"
              className="mt-6 inline-flex w-full items-center justify-center rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50"
            >
