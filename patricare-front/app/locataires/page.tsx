    ...
    <main className="w-full flex-1 px-4 py-8 md:py-8 space-y-6 md:space-y-10 bg-gray-50">
      <header className="space-y-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm md:p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h1 className="text-sm md:text-lg font-semibold text-blue-600">
          ...
          <div className="flex items-center md:col-span-2">
            ...
            <div className="w-full relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 bg-white py-3 pl-10 pr-4 text-sm md:text-lg text-gray-900 placeholder:text-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          <div className="rounded-xl border border-gray-200 bg-white p-4">
            <p className="text-sm md:text-lg text-gray-500">Locataires actifs</p>
            <p className="text-lg font-semibold text-gray-900">
              {tenants.length}
            </p>
          </div>
          <div className="rounded-xl border border-gray-200 bg-white p-4">
            <p className="text-sm md:text-lg text-gray-500">Revenus mensuels</p>
              ...
              <div className="mb-4 flex items-start justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-lg text-gray-500">{tenant.property}</p>
                  </div>
                </div>
                <span
                  className={`rounded-2xl px-3 py-2 text-md md:text-lg text-center font-semibold ${
              ...
              <div className="mb-4 space-y-3 border-b border-gray-100 pb-4 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="text-sm md:text-lg text-blue-600 hover:text-blue-700"
                  >
                    {tenant.email}
                  </a>
                </div>
              ...
              <div className="space-y-3 text-sm text-gray-600">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-lg">Loyer mensuel</span>
                  </div>
                  <span className="font-semibold text-sm md:text-lg text-right text-gray-900">
                    {tenant.rent}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm md:text-lg">Date de paiement</span>
                  </div>
                  <span className="font-semibold text-sm md:text-lg text-right text-gray-900">
                    {tenant.rentDate}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Calendar className="h-4 w-4" />
                    <span className="text-sm md:text-lg">Entrée dans les lieux</span>
                  </div>
                  <span className="font-semibold text-sm md:text-lg text-right text-gray-900">
                    {tenant.entryDate}
                  </span>
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
            ...
            <div className="space-y-4 p-6">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <label className="mb-2 block text-sm md:text-lg font-medium text-gray-700">
                    Nom complet
                  </label>
                  <input
                    type="text"
                    className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm md:text-lg focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm md:text-lg focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div className="flex gap-3 border-t border-gray-200 p-6">
              <button
                ...
                className="flex-1 rounded-lg border border-gray-300 px-4 py-2 text-sm md:text-lg font-medium text-gray-700 transition hover:bg-gray-50"
              >
                Annuler
              </button>
              <button
                onClick={() => setShowAddModal(false)}
                className="flex-1 rounded-lg bg-blue-400 hover:opacity-60 px-4 py-2 text-sm md:text-lg font-medium text-white transition hover:from-blue-700 hover:to-green-700"
              >
